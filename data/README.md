...
| :--- | :--- | :--- |
| **`discovered_ads.csv`** | `run_seads.py` | **Malicious Ads**. Domains found running Google Search Ads targeting your keywords (e.g., "login"). <br> **Why:** Scammers use ads to bypass organic search filters. These are high-priority blocks. |
| **`potential_typosquats.csv`** | `generate_permutations.py` | **Brand Impersonation**. Generated by `dnstwist`. Contains registered domains that look like your targets (e.g., `citibbank.com`). <br> **Why:** Early warning system for phishing campaigns before they launch. |
